...
- **WHEN** the pulley is turned by 3 degrees either way from its posed angle
- **THEN** it interferes with the belt, and turned by 0.5 degrees it does not; both at the default height and at the default plus half a tooth
