...
their 0.7 mm adhesive pads, so the glass top is `45 + 3.6 + 0.7 + 3 =
52.3` mm above the floor and the glass edge is 85 mm from the centre,
...
- **THEN** the glass's top face is at 52.3 mm within 0.01 and its centre within 0.05 mm of the machine axis
