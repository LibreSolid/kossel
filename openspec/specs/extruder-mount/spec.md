# extruder-mount Specification

## Purpose

The extruder bracket on the front top beam, the gearmotor in its cradle, the body on the motor, and the drive on the filament.
